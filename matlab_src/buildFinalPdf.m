...
"\vspace*{0.5cm}" newline ...
"{\Large 评分：\underline{\hspace{4cm}}}\hfill" newline ...
"\vspace{1.2cm}" newline ...
"{\Huge\bfseries SHANGHAI UNIVERSITY\\[0.8cm]}" newline ...
"{\zihao{1}\bfseries 课程论文\\[0.4cm]}" newline ...
"{\Large COURSE PAPER\\[1.8cm]}" newline ...
"{\zihao{2}\bfseries 基于 MATLAB 的高维混沌系统长期预测建模\\[2.0cm]}" newline ...
"\end{center}" newline ...
"\zihao{4}" newline ...
"\begin{tabular}{rl}" newline ...
"课程名称： & 人工智能导论 \\[0.45cm]" newline ...
"组\quad 长： & 钟兴涛\quad 学号：25120617 \\[0.45cm]" newline ...
"组\quad 员： & 唐亦明\quad 学号：25120638 \\[0.30cm]" newline ...
"          & 戴云天\quad 学号：25120636 \\[0.30cm]" newline ...
"          & 任宇航\quad 学号：25120699 \\[0.30cm]" newline ...
"          & 黄宇轩\quad 学号：25120619 \\[0.45cm]" newline ...
"打印日期： & \today \\[0.45cm]" newline ...
"教师评分： & \underline{\hspace{5cm}} \\[0.45cm]" newline ...
